...
`
		...
		expectedEnv := `PLATFORM_COMPONENT_OPENTRACING_OPENTRACING_JAEGER_AGENT_ENDPOINT="192.168.59.99:6831"
...
`
		...
		expectedEnv := `PLATFORM_COMPONENT_MINIO_MINIO_MINIO_HOST="127.0.0.1"
